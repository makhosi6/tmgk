...
require_once(__DIR__ . '/../../../web/modules/lt_course/vardefs.php');
require_once(__DIR__ . '/../../../web/modules/lt_student/vardefs.php');
require_once(__DIR__ . '/../../../web/modules/lt_teacher/vardefs.php');